...
public class Main {
    public static void main(String[] args) {
        ...
        linkedList2_2.addInTail(new Node_2(1));
        linkedList2_2.addInTail(new Node_2(2));
        linkedList2_2.addInTail(new Node_2(3));
        linkedList2_2.addInTail(new Node_2(4));
        linkedList2_2.addInTail(new Node_2(5));
        linkedList2_2.addInTail(new Node_2(6));
        linkedList2_2.addInTail(new Node_2(7));
        Node_2 current_2 = linkedList2_2.head;
